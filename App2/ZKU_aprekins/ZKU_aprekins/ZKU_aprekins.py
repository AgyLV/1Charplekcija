...
def main():
    ...
    '#ciemi sadalâs trîs vçrtîbu zonâs, katrai zonai mainâs koeficents/ villages splits in 3 zones, each zone has own coeficent'
    '#pilsçtas sadalâs septiòâs zonâs, katrai zonai mainâs procenti/ city splits in 7 zones, each zone have own precent value'
    '#zonas atkarîgas no zemes vienîbas platîbas./in witch zone is parcel depends on parcels area'
    '#veic aprçíinu/ done calculation'
    '#rezultats = mernieks uzzina pieïaujamo min un pieïaujamo max platîbu/ result = surveyor get know parcels allowed max and min area'
